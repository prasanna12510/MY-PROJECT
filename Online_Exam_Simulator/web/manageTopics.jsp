...
<html>
    ...
    <div id ="outer">
        ...
        <div id="pagecontent">
<%
LinkedList<LinkedList<Object>> allTopics;
LinkedList<Object> current;
LinkedList<String> header;
int i;
boolean flag;

header = top.getHeader();
allTopics = top.getAllTopics();

if(allTopics.size() > 0)
{
    out.println("<form name = \"f\" method = \"post\" action = \"manageTopics.jsp\" onsubmit= \"return check()\" >");
    //table
    ...
    flag = true;
    while(allTopics.size() > 0)
    {
        current = allTopics.remove(0);
        if(flag == true)
        {
            out.println("<tr>");
            flag = false;
