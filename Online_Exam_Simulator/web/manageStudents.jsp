...
<jsp:useBean id="stud" scope="page" class="onlineexams.User"/>
...
<html>
    ...
    <div id ="outer">
        ...
        <div id="pagecontent">
<%
LinkedList<LinkedList<Object>> allStudents;
LinkedList<Object> current;
LinkedList<String> header;
int i;
boolean flag;

header = stud.getHeader();
allStudents = stud.getUsersCategorywise("Student");

if(allStudents.size() > 0)
{
    out.println("<form name = \"f\" method = \"post\" action = \"manageStudents.jsp\" onsubmit= \"return check()\" >");
    //table
