...
Begin VB.Form frmSubjectDelete 
   ...
   End
End
Attribute VB_Name = "frmSubjectDelete"
...
Private Sub deleteRecord()
    ...
    If res = vbYes Then
        ...
        FlexGrid1.Row = FlexGrid1.RowSel 'FlexGrid1.RowSel gives the selected row
        FlexGrid1.Col = 1 ' col1 contains id
        id = CInt(FlexGrid1.Text)
        
        sql = "delete from subject where sid = " & id
